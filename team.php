        ...
        <section id="center" class="center_o">
			<div class="container">
				<div class="row center_o1 text-center">
					<div class="col-md-12">
						<h1 class="text-white font_60">Team Us</h1>
						<h6 class="col_light mb-0"><a class="col_light" href="#">Home</a> / <span
								class="col_oran">Team Us</span></h6>
					</div>
				</div>
			</div>
		</section>
...
<?php include 'public/team/team_h.php'; ?>
<?php include 'public/team/spec.php'; ?>
