...
// Fetch latest news
$news_list = db_get_all("SELECT * FROM posts WHERE type = 'blog' AND status = 'published' ORDER BY created_at DESC");
                ...
                <?php else: ?>
                    <div class="col-12 text-center mt-5">
                        <div class="bg-white p-5 rounded border shadow-sm d-inline-block">
                            ...
                            <h4 class="mt-3 text-secondary">Belum ada artikel terbaru.</h4>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
